...
class cv_viewer_c:
    ...
    ## 在给定的板块上画rectangle
    def draw_rectangle(self,xs,ys,xe,ye,color=(255,255,255),line_wid=5):
        cv2.rectangle(self.img_show,(xs,ys),(xe,ye),color,line_wid)
        return True
...
if __name__ == '__main__':
    ...
    #for k in range(500):
    mouse_down = False # 0 means button hasnt gone down; 1 means button has gone down; 2 means button has gone up
    xd,yd,xm,ym=0,0,320,240
    while True:
...
#        viewer.draw_line  (k%320, (k*2+10)%240, (k**2-k)%320, (k**3-k*23)%240, pan_id=(1,1))
        #viewer.draw_circle(20,5, 1, (1,1),(0,0,255),1)
...
#                    yf=yu%240
#                    print('end:(',xf,',',yf,')')
#                    viewer.draw_rectangle(xd,yd,xf,yf,(0,0,255),5)
#                    break
