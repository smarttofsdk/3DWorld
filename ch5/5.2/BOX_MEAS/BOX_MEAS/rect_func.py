# -*- coding: utf-8 -*-
"""
Created on Tue Mar 26 15:02:10 2019
...
def calc_box_dep_amp(img_dep,img_amp,n0,n1,n2,n3,mask=None,erode_ker=KER_ERODE):
    ...
    #if mask is not None: img_sel[~mask]=0
...
def convert_to_binary(original_image):
    ...
    gray_image =original_image.clip(0,255).astype(np.uint8).reshape((IMG_HGT,IMG_WID))#cv2.cvtColor(np.tile(np.expand_dims(original_image,-1),[1,1,3]), cv2.COLOR_RGB2GRAY)
